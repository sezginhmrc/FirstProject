...
public class MovieUtility {
    ...
    public static void main(String[] args) {
        // m1 is variable pointing the your movie object !
        ...
        boolean result2 = isFamilyMovie(m2);               //false
    ...
    public static void printMovieInformation(Movie movieObj) {
        //TODO YOUR CODE HERE
                                        // this method (getName) coming from My Movie class
        System.out.println("The movie " +movieObj.getName()+
                " is " +movieObj.getLength()+
                " hour long and it genre is "+ movieObj.getGenre());
    ...
    public static void printMovieNameCharacters(Movie movieObj) {
        //TODO YOUR CODE HERE
        String fixedName = "";
            if(movieObj.getName().equalsIgnoreCase("joker")){
                for (int i = 0; i <movieObj.getName().length()-1 ; i++) {
                   fixedName = fixedName + movieObj.getName().charAt(i)+"-";
                }
    ...
    public static void printShorterMovieName(Movie movieObj1, Movie movieObj2) {
        ...
        if(movieObj1.getLength()<movieObj2.getLength()){
            System.out.println("Shorter movies is : " + movieObj1.getName());
        } else {
