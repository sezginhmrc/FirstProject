...
public class FastFoodRestaurants {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Popeye's Chicken count is = " + popeyesCount);
        ...
        System.out.println();
        String [] first = restaurants[0].split(", ") ;
        System.out.println(restaurants[0]);

        System.out.println(first[2] + " -> " + first[1] + ", " + first[4]);
