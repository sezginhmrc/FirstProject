...
public class Map_valuesView2 {
    ...
    public static void main(String[] args) {
        ...
        //remove all the entry of the Map if the price value is more than 3

      //  allPrices.removeIf(eachPirce -> eachPirce>3);
      //  System.out.println(groceryPriceMap);
       ...
       // The logic is to use the strict connection between the view and the original map
        ...
        // How do i remove an item while iteartin over collection
        // using the iteartor..
