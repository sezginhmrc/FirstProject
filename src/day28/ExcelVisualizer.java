...
public class ExcelVisualizer {
   ...
   //     System.out.println(Arrays.deepToString(sheet));
        ...
        System.out.println(mySheet[1][2]); // it prints value in index of 1 index of 2
        System.out.println(mySheet[2][0]);
     //   System.out.println(Arrays.toString(mySheet[1]));
        System.out.println(mySheet.length);

        // How many item do I have in first item of this 2D array
        System.out.println(Arrays.toString(mySheet[0])); // seeing what's inside first 1d Array
        //System.out.println(mySheet[0].length); // getting the length of first 1D array
       // System.out.println(mySheet[1].length); // getting the length of second 1D array
        ...
        for (int i = 0; i <mySheet.length ; i++) {
            System.out.println("Item number " + (i+1) + " length " + mySheet[i].length ) ;
