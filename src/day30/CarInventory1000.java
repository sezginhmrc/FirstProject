...
public class CarInventory1000 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < cars.length; i++) {
            //      System.out.println( cars[i]);  // to print each car !
        ...
        for (int i = 0; i < cars.length; i++) {
            if (cars[i].equals("Honda-Civic")) {
                System.out.println("Civic location = " + i);
            }

        }
        System.out.println();

        // TASK 3: print make and model seprately in this format
        // honda-civic -->>
        // car make is honda model is civic !
        // print only honda brand cars
        // split method make sense...

        //String eachChar = "Honda-Civic"; // Honda-Civic is given here !! we don not need conditional statement !

        //
        //        String [] eachCarSplitted = eachChar.split("-");
        ...
        for (String eachChar : cars) {
            if (eachChar.startsWith("Ford")) {
                String[] eachCarSplitted = eachChar.split("-",3);
                System.out.println("car make is = " + eachCarSplitted[0] +
                        " car model is = " + eachCarSplitted[1]);
        ...
        // print the out
        // get the count
        // using split method to find if model has 2 char
        // to understand it correct plain english line 1073 !!!

        int count2CharModel = 0;
        for (String eachCar : cars) {
            String [] splitted = eachCar.split("-",2);
            String model = splitted[1]; // because we split the by - and second one model in requirement !
        ...
        System.out.println("Count 2 char car " + count2CharModel );
      ...
      //  Hint : first count toyota to find out your new array size then fill it up with toyota cars
        ...
        for(String eachCars :cars){
            if(eachCars.toLowerCase().contains("toyota")){
                countOfToyota++;
                if(eachCars.toUpperCase().contains("TOYOTA")){
                    String [] toyotaInventory = eachCars.split("-");
                    String make = toyotaInventory[0];
                    String model = toyotaInventory[1];
                    System.out.println("Count of toyota = " + countOfToyota);
                    System.out.println("Car make = " + make + " Car model is " + model) ;
                }
            }
        }
