...
public class WrapperReview {
    ...
    public static void main(String[] args) {
        ...
        // parseX method converting string to primitive using the Wrapper classes
        long lvalue = Long.parseLong("123");
        System.out.println("lvalue = " + lvalue);
        int ivalue =Integer.parseInt("321");
        System.out.println("ivalue = " + ivalue);

        Integer i = new Integer (123); // this is a rule returnin a new integer
        System.out.println("i = " + i);
        Integer ii = Integer.valueOf(123478901);
...
2, Wrap up primitive value to create Object
        ...
        * */
        ...
        int i4 = 54; // -->pure value stay in stack
